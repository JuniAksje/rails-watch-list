...
puts "Limpando filmes..."
Movie.destroy_all

puts "Criando filmes fixos..."
...
puts "Criando filmes a partir da API..."

url = "https://tmdb.lewagon.com/movie/top_rated"
serialized = URI.open(url).read
data = JSON.parse(serialized)

data["results"].first(10).each do |movie|
  # pula se já existir um filme com esse título
